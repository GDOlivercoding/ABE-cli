...
class _Help:
    ...
    battle_help.add_rows(
        (
            "battle",
            "get all battle names, and health bars (and rage chili charge)",
            "No args",
        ),
    ...
    controls_interface.add_rows(
        ...
        (
            "show",
            "show aliases for an action, leave empty to show all",
            escape("show [default]"),
        ),
        ...
        (
            "presets delete",
            "delete a user made preset collection",
            "presets delete <name>",
        ),
        (
            "defaults",
            "Show default aliases, unremovable... for a reason.",
            "No arguments",
        ),
